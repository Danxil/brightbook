            ...
            resolve: {
                category: function($q, $route, $timeout, $rootScope) {
                    ...
                    var categories = {
                        ...
                        8: {
                            title: 'Книги серии Мужчина и Женщина',
                            bg: '/images/books/cat-9-bg.jpg',
                            textColorSchema: 'black',
                            headerColor: 'black',
                            books: [
                                {
                        ...
                        9: {
                            title: 'Книги серии Теплые Истории',
                            bg: '/images/books/cat-10-bg.jpg',
                            textColorSchema: 'black',
                            headerColor: 'black',
                            books: [
                                {
